...
const SITE_URL = (getRuntimeEnv("NEXT_PUBLIC_SITE_URL") ?? "http://localhost:3000").replace(/\/+$/, "");
const LOGO_URL = `${SITE_URL}/brand/logo-white-512.png`;
