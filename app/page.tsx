...
function HowIcon({ step }: { step: "capture" | "review" | "understand" }) {
  return <span className={`how-icon how-icon-${step}`} aria-hidden="true"><span className="how-glyph"><i /><i /><i /></span></span>;
}
